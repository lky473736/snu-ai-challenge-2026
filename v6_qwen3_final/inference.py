"""
v6 Inference — DDP, 24-permutation exhaustive search (Qwen3-VL-8B base, 448px)
best_v6 and best_v6_last checkpoints → submission_v6_best.csv / submission_v6_last.csv
"""
...
CKPT_BASE  = Path("/data/gyuyeonlim/snu_ai_challenge/v6_qwen3_final/checkpoints")
DATA_DIR   = Path("/data/gyuyeonlim/snu_ai_challenge/data/snuaichallenge_data")
OUT_DIR    = Path("/data/gyuyeonlim/snu_ai_challenge/v6_qwen3_final")

CKPT_LIST = [
    ("best_v6",      "submission_v6_best"),
    ("best_v6_last", "submission_v6_last"),
]

MAX_SIZE    = 448  # train.py MAX_IMAGE_SIZE(448)와 반드시 일치 -> 이전에 512로 어긋나 재추론
