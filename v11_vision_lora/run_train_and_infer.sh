...
#SBATCH --output=/data/gyuyeonlim/snu_ai_challenge/v11_vision_lora/logs/train_v11_%j.out
#SBATCH --error=/data/gyuyeonlim/snu_ai_challenge/v11_vision_lora/logs/train_v11_%j.err
...
echo ""
echo "===================================================="
echo "STAGE 2: Inference (best_v11 / best_v11_last, DDP 4-GPU)"
echo "===================================================="
