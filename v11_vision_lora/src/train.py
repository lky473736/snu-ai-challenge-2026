...
def main():
    ...
    parser.add_argument("--ckpt_name",  type=str,   default="best_v11")
    parser.add_argument("--resume_from", type=str,  default=None,
                         help="job이 중간에 끊겼을 때 대비: 저장된 LoRA 체크포인트 경로(예: checkpoints/best_v11_last)"
    ...
    if is_main:
        ...
        print(f"[v11] Processes={accelerator.num_processes}  Device={device}")
