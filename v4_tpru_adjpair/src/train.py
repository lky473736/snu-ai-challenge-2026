"""
HNTV v4 Training — DDP via Accelerate
v4 redesign: full 23-perm coverage (d=1..6) + AdaptiveDistanceLoss + no_ordering aug
...
def main():
    ...
    parser.add_argument("--ckpt_name",  type=str,   default="best_v4")
    ...
    if is_main:
        ...
        print(f"[v4] Processes={accelerator.num_processes}  Device={device}")
        print(f"  lora_r={args.lora_r}  lora_alpha={args.lora_alpha}  lr={args.lr}")
        print(f"  Loss: AdaptiveDistanceLoss (all 23 perms, d=1..6 fully covered)")
