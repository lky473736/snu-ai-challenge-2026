"""
HNTV v4 Inference — DDP, 24-permutation exhaustive search
best_v4 and best_v4_last checkpoints → submission_v4_best.csv / submission_v4_last.csv
"""
...
CKPT_BASE  = Path("/data/gyuyeonlim/snu_ai_challenge/v4_tpru_adjpair/checkpoints")
DATA_DIR   = Path("/data/gyuyeonlim/snu_ai_challenge/data/snuaichallenge_data")
OUT_DIR    = Path("/data/gyuyeonlim/snu_ai_challenge/v4_tpru_adjpair")

CKPT_LIST = [
    ("best_v4",      "submission_v4_best"),
    ("best_v4_last", "submission_v4_last"),
]
