...
#SBATCH --output=/data/gyuyeonlim/snu_ai_challenge/v7_nounloss/logs/train_v7_%j.out
#SBATCH --error=/data/gyuyeonlim/snu_ai_challenge/v7_nounloss/logs/train_v7_%j.err
