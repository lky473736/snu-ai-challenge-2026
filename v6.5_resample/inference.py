"""
v6.5 Inference — DDP, 24-permutation exhaustive search (Qwen3-VL-8B base, 448px)
best_v6_5 and best_v6_5_last checkpoints → submission_v6_5_best.csv / submission_v6_5_last.csv
"""
...
CKPT_BASE  = Path("/data/gyuyeonlim/snu_ai_challenge/v6.5_resample/checkpoints")
DATA_DIR   = Path("/data/gyuyeonlim/snu_ai_challenge/data/snuaichallenge_data")
OUT_DIR    = Path("/data/gyuyeonlim/snu_ai_challenge/v6.5_resample")

CKPT_LIST = [
    ("best_v6_5",      "submission_v6_5_best"),
    ("best_v6_5_last", "submission_v6_5_last"),
]
