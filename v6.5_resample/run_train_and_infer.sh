...
#SBATCH --output=/data/gyuyeonlim/snu_ai_challenge/v6.5_resample/logs/train_v6_5_%j.out
#SBATCH --error=/data/gyuyeonlim/snu_ai_challenge/v6.5_resample/logs/train_v6_5_%j.err
...
echo ""
echo "===================================================="
echo "STAGE 2: Inference (best_v6_5 / best_v6_5_last, DDP 4-GPU)"
echo "===================================================="
