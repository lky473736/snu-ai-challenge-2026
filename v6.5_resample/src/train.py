"""
HNTV v6.5 Training — DDP via Accelerate
v6.5: v6(Qwen3-VL-8B base + 448px + WEIGHT_TEMP=6)에서 hard negative를 학습 시작 전
...
def main():
    ...
    parser.add_argument("--ckpt_name",  type=str,   default="best_v6_5")
    parser.add_argument("--resume_from", type=str,  default=None,
                         help="job이 중간에 끊겼을 때 대비: 저장된 LoRA 체크포인트 경로(예: checkpoints/best_v6_5_last)"
    ...
    if is_main:
        ...
        print(f"[v6.5] Processes={accelerator.num_processes}  Device={device}")
