...
best_v8 and best_v8_last checkpoints → submission_v8_best.csv / submission_v8_last.csv
"""
...
CKPT_BASE  = Path("/data/gyuyeonlim/snu_ai_challenge/v8_lora128/checkpoints")
DATA_DIR   = Path("/data/gyuyeonlim/snu_ai_challenge/data/snuaichallenge_data")
OUT_DIR    = Path("/data/gyuyeonlim/snu_ai_challenge/v8_lora128")

CKPT_LIST = [
    ("best_v8",      "submission_v8_best"),
    ("best_v8_last", "submission_v8_last"),
]
