"""
v10 Inference — DDP, 24-permutation exhaustive search (Qwen3-VL-8B base, 448px, AdaptiveDistanceNounLoss)
best_v10 and best_v10_last checkpoints → submission_v10_best.csv / submission_v10_last.csv
"""
...
CKPT_BASE  = Path("/data/gyuyeonlim/snu_ai_challenge/v10_nounloss_retry/checkpoints")
DATA_DIR   = Path("/data/gyuyeonlim/snu_ai_challenge/data/snuaichallenge_data")
OUT_DIR    = Path("/data/gyuyeonlim/snu_ai_challenge/v10_nounloss_retry")

CKPT_LIST = [
    ("best_v10",      "submission_v10_best"),
    ("best_v10_last", "submission_v10_last"),
]
