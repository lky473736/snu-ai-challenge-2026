"""
v14 Inference (ListwiseSoftmaxLoss) — DDP, 24-permutation exhaustive search (Qwen3-VL-8B base, 448px)
best_v14 and best_v14_last checkpoints → submission_v14_best.csv / submission_v14_last.csv
"""
...
CKPT_BASE  = Path("/data/gyuyeonlim/snu_ai_challenge/v14_listwise_softmax/checkpoints")
DATA_DIR   = Path("/data/gyuyeonlim/snu_ai_challenge/data/snuaichallenge_data")
OUT_DIR    = Path("/data/gyuyeonlim/snu_ai_challenge/v14_listwise_softmax")

CKPT_LIST = [
    ("best_v14",      "submission_v14_best"),
    ("best_v14_last", "submission_v14_last"),
]

MAX_SIZE    = 448  # train.py MAX_IMAGE_SIZE와 반드시 일치
INFER_BATCH = 24  # OOM 나면 자동으로 줄어듦
