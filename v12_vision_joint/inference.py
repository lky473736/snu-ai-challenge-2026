...
best_v12 and best_v12_last checkpoints → submission_v12_best.csv / submission_v12_last.csv
"""
...
CKPT_BASE  = Path("/data/gyuyeonlim/snu_ai_challenge/v12_vision_joint/checkpoints")
DATA_DIR   = Path("/data/gyuyeonlim/snu_ai_challenge/data/snuaichallenge_data")
OUT_DIR    = Path("/data/gyuyeonlim/snu_ai_challenge/v12_vision_joint")

CKPT_LIST = [
    ("best_v12",      "submission_v12_best"),
    ("best_v12_last", "submission_v12_last"),
]
