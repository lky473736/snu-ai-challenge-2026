...
#SBATCH --output=/data/gyuyeonlim/snu_ai_challenge/v12_vision_joint/logs/train_v12_%j.out
#SBATCH --error=/data/gyuyeonlim/snu_ai_challenge/v12_vision_joint/logs/train_v12_%j.err
...
echo ""
echo "===================================================="
echo "STAGE 2: Inference (best_v12 / best_v12_last, DDP 4-GPU)"
echo "===================================================="
