...
#SBATCH --output=/data/gyuyeonlim/snu_ai_challenge/v9_dora/logs/train_v9_%j.out
#SBATCH --error=/data/gyuyeonlim/snu_ai_challenge/v9_dora/logs/train_v9_%j.err
...
echo ""
echo "===================================================="
echo "STAGE 2: Inference (best_v9 / best_v9_last, DDP 4-GPU)"
echo "===================================================="
