"""
v9 Inference (LoRA r=128 + DoRA) — DDP, 24-permutation exhaustive search (Qwen3-VL-8B base, 448px)
best_v9 and best_v9_last checkpoints → submission_v9_best.csv / submission_v9_last.csv
"""
...
CKPT_BASE  = Path("/data/gyuyeonlim/snu_ai_challenge/v9_dora/checkpoints")
DATA_DIR   = Path("/data/gyuyeonlim/snu_ai_challenge/data/snuaichallenge_data")
OUT_DIR    = Path("/data/gyuyeonlim/snu_ai_challenge/v9_dora")

CKPT_LIST = [
    ("best_v9",      "submission_v9_best"),
    ("best_v9_last", "submission_v9_last"),
]
