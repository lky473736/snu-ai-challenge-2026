"""
v15 Inference (ListwiseSoftmaxLoss + 동적 하드 네거티브 뱅크) — DDP, 24-permutation exhaustive search
(Qwen3-VL-8B base, 448px)
best_v15 and best_v15_last checkpoints → submission_v15_best.csv / submission_v15_last.csv
"""
...
CKPT_BASE  = Path("/data/gyuyeonlim/snu_ai_challenge/v15_dynamic_hardneg/checkpoints")
DATA_DIR   = Path("/data/gyuyeonlim/snu_ai_challenge/data/snuaichallenge_data")
OUT_DIR    = Path("/data/gyuyeonlim/snu_ai_challenge/v15_dynamic_hardneg")

CKPT_LIST = [
    ("best_v15",      "submission_v15_best"),
    ("best_v15_last", "submission_v15_last"),
]
